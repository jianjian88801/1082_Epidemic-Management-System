...
public class ZhiliaoxinxiView extends ZhiliaoxinxiEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 是否重症的值
		*/
		private String zhongzhengValue;
	...
	public ZhiliaoxinxiView() {

	}

	public ZhiliaoxinxiView(ZhiliaoxinxiEntity zhiliaoxinxiEntity) {
		try {
			BeanUtils.copyProperties(this, zhiliaoxinxiEntity);
			...
			* 获取： 是否重症的值
			*/
			public String getZhongzhengValue() {
				return zhongzhengValue;
			}
			/**
			* 设置： 是否重症的值
			*/
			public void setZhongzhengValue(String zhongzhengValue) {
				this.zhongzhengValue = zhongzhengValue;
			}
