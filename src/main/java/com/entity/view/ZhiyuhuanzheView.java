...
public class ZhiyuhuanzheView extends ZhiyuhuanzheEntity implements Serializable {
	...
	public ZhiyuhuanzheView() {

	}

	public ZhiyuhuanzheView(ZhiyuhuanzheEntity zhiyuhuanzheEntity) {
		try {
			BeanUtils.copyProperties(this, zhiyuhuanzheEntity);
