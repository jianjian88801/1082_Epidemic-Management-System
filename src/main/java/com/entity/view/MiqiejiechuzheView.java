...
public class MiqiejiechuzheView extends MiqiejiechuzheEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 隔离类型的值
		*/
		private String miqiejiechuzheGeliValue;
	...
	public MiqiejiechuzheView() {

	}

	public MiqiejiechuzheView(MiqiejiechuzheEntity miqiejiechuzheEntity) {
		try {
			BeanUtils.copyProperties(this, miqiejiechuzheEntity);
			...
			* 获取： 隔离类型的值
			*/
			public String getMiqiejiechuzheGeliValue() {
				return miqiejiechuzheGeliValue;
			}
			/**
			* 设置： 隔离类型的值
			*/
			public void setMiqiejiechuzheGeliValue(String miqiejiechuzheGeliValue) {
				this.miqiejiechuzheGeliValue = miqiejiechuzheGeliValue;
			}
