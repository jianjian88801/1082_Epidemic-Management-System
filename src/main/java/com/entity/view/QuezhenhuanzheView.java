...
public class QuezhenhuanzheView extends QuezhenhuanzheEntity implements Serializable {
	...
	public QuezhenhuanzheView() {

	}

	public QuezhenhuanzheView(QuezhenhuanzheEntity quezhenhuanzheEntity) {
		try {
			BeanUtils.copyProperties(this, quezhenhuanzheEntity);
