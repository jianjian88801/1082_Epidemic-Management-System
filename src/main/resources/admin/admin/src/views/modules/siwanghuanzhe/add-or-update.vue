    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="huanzheId" name="huanzheId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="死亡患者编号" prop="siwanghuanzheUuidNumber">
                       <el-input v-model="ruleForm.siwanghuanzheUuidNumber"
                                 placeholder="死亡患者编号" clearable  :readonly="ro.siwanghuanzheUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="死亡患者编号" prop="siwanghuanzheUuidNumber">
                           <el-input v-model="ruleForm.siwanghuanzheUuidNumber"
                                     placeholder="死亡患者编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="死亡备注" prop="siwanghuanzheContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.siwanghuanzheContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.siwanghuanzheContent" label="死亡备注" prop="siwanghuanzheContent">
                            <span v-html="ruleForm.siwanghuanzheContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="死亡时间" prop="quezhenTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.quezhenTime" label="死亡时间" prop="quezhenTime">
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    huanzheId: false,
                    siwanghuanzheUuidNumber: false,
                    siwanghuanzheContent: false,
                    quezhenTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    huanzheId: '',
                    siwanghuanzheUuidNumber: new Date().getTime(),
                    siwanghuanzheContent: '',
                    quezhenTime: '',
                    insertTime: '',
                },
                huanzheOptions : [],
                rules: {
                   ...
                   siwanghuanzheUuidNumber: [
                              { required: true, message: '死亡患者编号不能为空', trigger: 'blur' },
                          ],
                   siwanghuanzheContent: [
                              { required: true, message: '死亡备注不能为空', trigger: 'blur' },
                          ],
                   quezhenTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`siwanghuanzhe/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.siwanghuanzheCrossAddOrUpdateFlag = false;
                                        this.parent.search();
