    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="huanzheId" name="huanzheId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="治愈患者编号" prop="zhiyuhuanzheUuidNumber">
                       <el-input v-model="ruleForm.zhiyuhuanzheUuidNumber"
                                 placeholder="治愈患者编号" clearable  :readonly="ro.zhiyuhuanzheUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="治愈患者编号" prop="zhiyuhuanzheUuidNumber">
                           <el-input v-model="ruleForm.zhiyuhuanzheUuidNumber"
                                     placeholder="治愈患者编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="治愈备注" prop="zhiyuhuanzheContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.zhiyuhuanzheContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.zhiyuhuanzheContent" label="治愈备注" prop="zhiyuhuanzheContent">
                            <span v-html="ruleForm.zhiyuhuanzheContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="治愈时间" prop="quezhenTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.quezhenTime" label="治愈时间" prop="quezhenTime">
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    huanzheId: false,
                    zhiyuhuanzheUuidNumber: false,
                    zhiyuhuanzheContent: false,
                    quezhenTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    huanzheId: '',
                    zhiyuhuanzheUuidNumber: new Date().getTime(),
                    zhiyuhuanzheContent: '',
                    quezhenTime: '',
                    insertTime: '',
                },
                ...
                rules: {
                   ...
                   zhiyuhuanzheUuidNumber: [
                              { required: true, message: '治愈患者编号不能为空', trigger: 'blur' },
                          ],
                   zhiyuhuanzheContent: [
                              { required: true, message: '治愈备注不能为空', trigger: 'blur' },
                          ],
                   quezhenTime: [
                              { required: true, message: '治愈时间不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`zhiyuhuanzhe/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.zhiyuhuanzheCrossAddOrUpdateFlag = false;
                                        this.parent.search();
