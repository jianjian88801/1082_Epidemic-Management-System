    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="huanzheId" name="huanzheId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="确诊患者编号" prop="quezhenhuanzheUuidNumber">
                       <el-input v-model="ruleForm.quezhenhuanzheUuidNumber"
                                 placeholder="确诊患者编号" clearable  :readonly="ro.quezhenhuanzheUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="确诊患者编号" prop="quezhenhuanzheUuidNumber">
                           <el-input v-model="ruleForm.quezhenhuanzheUuidNumber"
                                     placeholder="确诊患者编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="确诊位置" prop="quezhenhuanzheGeliAddress">
                       <el-input v-model="ruleForm.quezhenhuanzheGeliAddress"
                                 placeholder="确诊位置" clearable  :readonly="ro.quezhenhuanzheGeliAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="确诊位置" prop="quezhenhuanzheGeliAddress">
                           <el-input v-model="ruleForm.quezhenhuanzheGeliAddress"
                                     placeholder="确诊位置" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="确诊备注" prop="quezhenhuanzheContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.quezhenhuanzheContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.quezhenhuanzheContent" label="确诊备注" prop="quezhenhuanzheContent">
                            <span v-html="ruleForm.quezhenhuanzheContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="确诊时间" prop="quezhenTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.quezhenTime"
                                type="datetime"
                                placeholder="确诊时间"
                                :disabled="ro.quezhenTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.quezhenTime" label="确诊时间" prop="quezhenTime">
                            <span v-html="ruleForm.quezhenTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    huanzheId: false,
                    quezhenhuanzheUuidNumber: false,
                    quezhenhuanzheGeliAddress: false,
                    quezhenhuanzheContent: false,
                    quezhenTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    huanzheId: '',
                    quezhenhuanzheUuidNumber: new Date().getTime(),
                    quezhenhuanzheGeliAddress: '',
                    quezhenhuanzheContent: '',
                    quezhenTime: '',
                    insertTime: '',
                },
                huanzheOptions : [],
                rules: {
                   ...
                   quezhenhuanzheUuidNumber: [
                              { required: true, message: '确诊患者编号不能为空', trigger: 'blur' },
                          ],
                   quezhenhuanzheGeliAddress: [
                              { required: true, message: '确诊位置不能为空', trigger: 'blur' },
                          ],
                   quezhenhuanzheContent: [
                              { required: true, message: '确诊备注不能为空', trigger: 'blur' },
                          ],
                   quezhenTime: [
                              { required: true, message: '确诊时间不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`quezhenhuanzhe/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.quezhenhuanzheCrossAddOrUpdateFlag = false;
                                        this.parent.search();
